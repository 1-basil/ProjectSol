  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Perf: cap DPR -- full retina + bloom is the main cost on hi-dpi screens.
        ...
        this.assets = {};
        this.disposed = false;
        // Perf: skip all rendering while the canvas is off-screen.
        this.visible = true;
      ...
      init() {
        // loadAssets resolves asynchronously; under React Strict Mode the app may
        // already be disposed (WebGL context lost) by the time we get here.
